...
def sauvola(img, k=0.2, kernerl=(31, 31)):
    '''
    sauvola阈值法。
...
# 直接读取单通道灰度图
gray_img = cv.imread('E:/sxl_Programs/Python/PDF/22/1/138_page1.png', cv.IMREAD_GRAYSCALE)

dst_img=sauvola(gray_img, k=0.3, kernerl=(191, 191))

cv.imwrite('D:/191_3.png', dst_img)
